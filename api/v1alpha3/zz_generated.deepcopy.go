...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JujuConfiguration) DeepCopyInto(out *JujuConfiguration) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JujuConfiguration.
func (in *JujuConfiguration) DeepCopy() *JujuConfiguration {
	if in == nil {
		return nil
	}
	out := new(JujuConfiguration)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *JujuConfiguration) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JujuConfigurationList) DeepCopyInto(out *JujuConfigurationList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]JujuConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JujuConfigurationList.
func (in *JujuConfigurationList) DeepCopy() *JujuConfigurationList {
	if in == nil {
		return nil
	}
	out := new(JujuConfigurationList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *JujuConfigurationList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JujuConfigurationSpec) DeepCopyInto(out *JujuConfigurationSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JujuConfigurationSpec.
func (in *JujuConfigurationSpec) DeepCopy() *JujuConfigurationSpec {
	if in == nil {
		return nil
	}
	out := new(JujuConfigurationSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JujuConfigurationStatus) DeepCopyInto(out *JujuConfigurationStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JujuConfigurationStatus.
func (in *JujuConfigurationStatus) DeepCopy() *JujuConfigurationStatus {
	if in == nil {
		return nil
	}
	out := new(JujuConfigurationStatus)
	in.DeepCopyInto(out)
	return out
}
